import Foundation
import XCTest
@testable import CodexOpsConsole
...
final class CoreTests: XCTestCase {
    ...
    func testPortableSkillLocatorUsesConfiguredRoot() throws {
        ...
        let locator = PortableSkillLocator(environment: ["HOLYSKILLS_ROOT": root.path], home: "/unused", currentDirectory: "/unused")
    ...
    func testPackagedSkillLocatorPrefersBundledHelperAndKeepsExplicitOverride() throws {
        ...
        let bundleRoot = root.appendingPathComponent("CodexOpsConsole.app/Contents/Resources")
        ...
        let explicitlyOverridden = PortableSkillLocator(
            environment: ["HOLYSKILLS_ROOT": override.path],
            home: home.path,
            currentDirectory: checkout.path,
            bundleResourceRoot: bundleRoot.path
        )
