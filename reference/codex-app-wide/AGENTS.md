...
- Prefer production-grade foundations suited to the required capabilities and
  lifecycle. Evaluate correctness, maintainability, operability, security,
  scale, cost, and migration difficulty instead of defaulting to either the
  smallest or most elaborate option.
