    ...
    if delivery:
        _require_terms(
            ...
            (
                ...
                "exactly one authoritative completion ledger",
                "recorded project decision",
                "reviewed software-owned database ledger",
